...
void reg_opcua_enums(sol::table& module) {
	...
	module.new_enum("UA_MessageSecurityMode",
		"UA_MESSAGESECURITYMODE_INVALID", UA_MessageSecurityMode::UA_MESSAGESECURITYMODE_INVALID,
		"UA_MESSAGESECURITYMODE_NONE", UA_MessageSecurityMode::UA_MESSAGESECURITYMODE_NONE,
		"UA_MESSAGESECURITYMODE_SIGN", UA_MessageSecurityMode::UA_MESSAGESECURITYMODE_SIGN,
		"UA_MESSAGESECURITYMODE_SIGNANDENCRYPT", UA_MessageSecurityMode::UA_MESSAGESECURITYMODE_SIGNANDENCRYPT
	);
	...
	module.new_enum("ValueRank",
		"SCALAR_OR_ONE_DIMENSION", UA_VALUERANK_SCALAR_OR_ONE_DIMENSION,
		"ANY", UA_VALUERANK_ANY,
		"SCALAR", UA_VALUERANK_SCALAR,
		"ONE_OR_MORE_DIMENSIONS", UA_VALUERANK_ONE_OR_MORE_DIMENSIONS,
		"ONE_DIMENSION", UA_VALUERANK_ONE_DIMENSION,
		"TWO_DIMENSIONS", UA_VALUERANK_TWO_DIMENSIONS,
		"THREE_DIMENSIONS", UA_VALUERANK_THREE_DIMENSIONS
	);
